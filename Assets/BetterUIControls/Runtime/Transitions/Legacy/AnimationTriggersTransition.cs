...
{
    [Serializable]
    public class AnimationTriggersTransition : TransitionBehaviour<Animator>
    {
        [HideLabel] [SerializeField] private AnimationTriggers _animationTriggers = new AnimationTriggers();
